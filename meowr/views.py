...
def section_detail(request, slug):
	...
	return object_list(
	request, 
	queryset=section.live_article_set(),
	paginate_by=25, 
	extra_context={ 'section': section, }, 
	template_name = 'meowr/section_detail.html',
	)
...
def rating_detail(request, slug):
	...
	return object_list(
	request, 
	queryset=rating.live_article_set(),
	paginate_by=10, 
	extra_context={ 'rating': rating }, 
	template_name = 'meowr/article_rating_detail.html',
	)
